...
void CDlgCharBasicInfo::UpdateUI(const CD2S_Struct & character)
{
	...
	m_dwStrength = character.PlayerStats.m_dwValue[0];
	m_dwEnergy = character.PlayerStats.m_dwValue[1];
	m_dwDexterity = character.PlayerStats.m_dwValue[2];
	m_dwVitality = character.PlayerStats.m_dwValue[3];
	m_dwStatPointsRemaining = character.PlayerStats.m_dwValue[4];
	m_dwSkillPointsRemaining = character.PlayerStats.m_dwValue[5];
	m_dwCurrentLife = character.PlayerStats.m_dwValue[6] >> 8;
	m_dwMaximumLife = character.PlayerStats.m_dwValue[7] >> 8;
	m_dwCurrentMana = character.PlayerStats.m_dwValue[8] >> 8;
	m_dwMaximumMana = character.PlayerStats.m_dwValue[9] >> 8;
	m_dwCurrentStamina = character.PlayerStats.m_dwValue[0xA] >> 8;
	m_dwMaximumStamina = character.PlayerStats.m_dwValue[0xB] >> 8;
	m_uCharLevel = BYTE(character.PlayerStats.m_dwValue[0xC]);
	m_dwExperience = character.PlayerStats.m_dwValue[0xD];
	m_dwGoldInBody = character.PlayerStats.m_dwValue[0xE];
	m_dwGoldInStash = character.PlayerStats.m_dwValue[0xF];
...
BOOL CDlgCharBasicInfo::GatherData(CD2S_Struct & character)
{
	...
	character.PlayerStats.m_dwValue[0] = m_dwStrength;
	character.PlayerStats.m_dwValue[1] = m_dwEnergy;
	character.PlayerStats.m_dwValue[2] = m_dwDexterity;
	character.PlayerStats.m_dwValue[3] = m_dwVitality;
	character.PlayerStats.m_dwValue[4] = m_dwStatPointsRemaining;
	character.PlayerStats.m_dwValue[5] = m_dwSkillPointsRemaining;
	character.PlayerStats.m_dwValue[6] = m_dwCurrentLife << 8;
	character.PlayerStats.m_dwValue[7] = m_dwMaximumLife << 8;
	character.PlayerStats.m_dwValue[8] = m_dwCurrentMana << 8;
	character.PlayerStats.m_dwValue[9] = m_dwMaximumMana << 8;
	character.PlayerStats.m_dwValue[0xA] = m_dwCurrentStamina << 8;
	character.PlayerStats.m_dwValue[0xB] = m_dwMaximumStamina << 8;
	character.PlayerStats.m_dwValue[0xC] = character.charLevel = m_uCharLevel;
	character.PlayerStats.m_dwValue[0xD] = m_dwExperience;
	character.PlayerStats.m_dwValue[0xE] = m_dwGoldInBody;
	character.PlayerStats.m_dwValue[0xF] = m_dwGoldInStash;
