...
{
	std::string name;
	WORD PicIndex = 0, NameIndex = 0;
	BYTE Equip = 0, Range = 0;
	BOOL HasDef = FALSE, HasDur = FALSE, IsStacked = FALSE, IsTome = FALSE, HasMonsterID = FALSE, IsCharm = FALSE, HasSpellID = FALSE, IsUnique = FALSE;
	UINT Damage1Min = 0, Damage1Max = 0, Damage2Min = 0, Damage2Max = 0;
};
